...
def create_network():    
    ...
    layers = network.create_feedforward_network([2, 3, 2, 1], clear_existing=True)
    ...
    for pre_id, post_id, weight, delay in weight_matrix:
        network.connect_neurons(pre_neuron_id=pre_id, post_neuron_id=post_id, weight=weight, delay=delay)
